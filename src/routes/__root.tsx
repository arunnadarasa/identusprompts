...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Hyperledger Identus Catalyst — 1,000 self-sovereign identity ideas for Lovable" },
      { name: "twitter:description", content: "A browseable catalog of 1,000 mega-prompts that wire Hyperledger Identus — did:prism, DIDComm, verifiable credentials and proofs — into ten creative disciplines." },
