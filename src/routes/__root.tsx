...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Creative AI — 1,000 ElevenLabs hackathon ideas" },
      { name: "description", content: "An archive of 1,000 copy-paste Lovable mega-prompts that wire ElevenLabs text-to-speech, voice agents, realtime transcription, and music + SFX into ten creative disciplines." },
      ...
      { property: "og:description", content: "An archive of 1,000 copy-paste Lovable mega-prompts that wire ElevenLabs text-to-speech, voice agents, realtime transcription, and music + SFX into ten creative disciplines." },
