...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AIsa Creative — 1,000 AIsa hackathon ideas" },
      { name: "description", content: "An archive of 1,000 copy-paste Lovable mega-prompts that wire AIsa chat completions, AIsa chat, live web skills, and video reels into ten creative disciplines." },
      ...
      { property: "og:description", content: "An archive of 1,000 copy-paste Lovable mega-prompts that wire AIsa chat completions, AIsa chat, live web skills, and video reels into ten creative disciplines." },
