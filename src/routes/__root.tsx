...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Sprites Creative — 1,000 fly.io Sprites hackathon ideas for Lovable" },
      { name: "twitter:description", content: "A browseable repo of 1,000 mega-prompts that wire fly.io Sprites — create, filesystem drops, long-running services and exec — into ten creative disciplines. Built during the Sprites Creative Hackathon." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/7435b1b4-3ce9-483f-9502-1b69f843b12f" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/7435b1b4-3ce9-483f-9502-1b69f843b12f" },
    ],
    links: [
      {
        rel: "stylesheet",
