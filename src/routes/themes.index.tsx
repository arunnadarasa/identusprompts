...
export const Route = createFileRoute("/themes/")({
  head: () => ({
    meta: [
      { title: "All themes · Hyperledger Identus Catalyst" },
      { name: "description", content: "10 creative disciplines, 100 Hyperledger Identus hackathon ideas each." },
      { property: "og:title", content: "All themes · Hyperledger Identus Catalyst" },
      { property: "og:description", content: "10 creative disciplines, 100 Hyperledger Identus hackathon ideas each." },
    ],
  }),
        ...
        <header className="flex flex-col md:flex-row md:items-end md:justify-between border-b border-border pb-8 gap-6">
          <div className="max-w-3xl">
            ...
            <p className="mt-7 text-base sm:text-lg text-muted-foreground max-w-xl font-light leading-relaxed">
              Each house holds one hundred buildable entries — every entry paired with a Lovable mega-prompt and an Identus primitive.
            </p>
          </div>
